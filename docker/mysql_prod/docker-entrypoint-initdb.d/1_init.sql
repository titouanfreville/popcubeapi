...
-- sam. 08 avril 2017 23:03:52 CEST
...
-- Table `popcube`.`reads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `popcube`.`reads` (
  `idUser` INT UNSIGNED NOT NULL,
  `idChannel` INT UNSIGNED NOT NULL,
  `idMessage` INT UNSIGNED NOT NULL,
...
CREATE INDEX `fk_Read_Channel_idx` ON `popcube`.`reads` (`idChannel` ASC);

CREATE INDEX `fk_Read_Message_idx` ON `popcube`.`reads` (`idMessage` ASC);
...
CREATE TABLE IF NOT EXISTS `popcube`.`members` (
  ...
  `timeOutEnd` BIGINT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `popcube_test`.`reads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `popcube_test`.`reads` (
  `idUser` INT UNSIGNED NOT NULL,
  `idChannel` INT UNSIGNED NOT NULL,
  `idMessage` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idUser`, `idChannel`, `idMessage`),
...
CREATE INDEX `fk_Read_Channel_idx` ON `popcube_test`.`reads` (`idChannel` ASC);

CREATE INDEX `fk_Read_Message_idx` ON `popcube_test`.`reads` (`idMessage` ASC);
...
CREATE TABLE IF NOT EXISTS `popcube_dev`.`members` (
  ...
  `idRole` INT UNSIGNED NULL,
  `timedOut` TINYINT(1) NOT NULL DEFAULT 0,
  `timeOutEnd` BIGINT UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`idUser`, `idChannel`),
  CONSTRAINT `fk_Member_User`
    FOREIGN KEY (`idUser`)
    REFERENCES `popcube_dev`.`users` (`idUser`)
...
-- -----------------------------------------------------
-- Table `popcube_dev`.`reads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `popcube_dev`.`reads` (
  `idUser` INT UNSIGNED NOT NULL,
  `idChannel` INT UNSIGNED NOT NULL,
  `idMessage` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idUser`, `idChannel`, `idMessage`),
...
CREATE INDEX `fk_Read_Channel_idx` ON `popcube_dev`.`reads` (`idChannel` ASC);

CREATE INDEX `fk_Read_Message_idx` ON `popcube_dev`.`reads` (`idMessage` ASC);

...
ADD swagger.yml /tmp/swagger
ADD docker_resources/swagger /home/swagger

# ADD docker_resources/source /home/slate/source
# RUN ls /home/slate/source
RUN cd /home/slate && bundle install
...
CMD java -jar /home/swagger/swagger-codegen-cli.jar generate -i /tmp/swagger -l swagger -v -o /home/slate/json/popcubeapi > /dev/null && \
    ...
    php /home/swagger/index.php convert /home/slate/json/popcubeapi/swagger.json > /home/slate/popcubeapi.html.md && \
